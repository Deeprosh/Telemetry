...
## Authentication:  
- Authentication will be done using creating an user in AWS which is nothing but an IAM user using IAM service.  
- Creating an User in AWS using IAM service can be done in 2 ways:  
1. Using AWS CLI  
2. Using AWS GUI  
- 
